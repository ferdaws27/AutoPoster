...
export default function QuoteTemplate() {
  ...
  const generateVariations = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/quote-generator/generate`, {
      ...
      showToast("Quote variations generated successfully!", "success");

    } catch (error) {

      console.error("Error generating variations:", error);

      showToast(error.message || "Failed to generate quote variations", "warning");
    ...
    {variations.map((variation, index) => (
      ...
      <div key={index} className="rounded-3xl p-6 bg-white/5">
        ...
        <div className="bg-black/30 rounded-2xl p-4 mb-4">
          ...
          <p className="text-gray-200 whitespace-pre-line">{variation.text}</p>
